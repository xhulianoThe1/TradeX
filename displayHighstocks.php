...
<?php
    ...
    try {
        ...
        */
        ...
        $selectTickers = $connection->prepare("SELECT tickers FROM portfolios WHERE portfolio_id =:portfolio_id LIMIT 1");
        $selectTickers->execute(['portfolio_id'=>$portfolio_id]);
...
<form autocomplete="off" onsubmit="testFunction(stockName)">
