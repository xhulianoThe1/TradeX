  ...
  $.getJSON('https://www.quandl.com/api/v3/datasets/WIKI/' + name.toLowerCase() + '.json?start_date='+dates[i]+'&column_index=11&auth_token=W8yzMDsJZ_TEcrPjWxGn', function(data) {
    ...
    data.dataset.data.forEach(function(point) {
      newData.push([Number(point[1])*NumberOfStocks]);
            ...
            document.getElementById('individualPrice' + i).innerHTML = 'Latest Adj. Closing Price: $'+ (newData[0]) / NumberOfStocks;
      document.getElementById('totalPrice' + i).innerHTML = 'Total Value the shares of this Asset Contribute to Portfolio: $'+ newData[0];
