...
<?php
    ...
    try {
      ...
      //amount of each stock retrieved
        ...
        $_SESSION['amounts'] = $stmt->fetchAll();
...
<script>
    ...
    var amounts = new Array();
        <?php foreach($_SESSION['amounts'] as $key => $val){ ?>
...
$.each(names, function(i, name) {
  $.getJSON('https://www.quandl.com/api/v3/datasets/WIKI/' + name.toLowerCase() + '.json?start_date='+dates[i]+'&column_index=11&auth_token=W8yzMDsJZ_TEcrPjWxGn', function(data) {
    ...
    data.dataset.data.forEach(function(point) {
      newData.push([new Date(point[0]).getTime(), Number(point[1])*NumberOfStocks]);
    });

      //adding price to tabular data... both in terms of current total contribution and latest individual value of asset
      document.getElementById('individualPrice' + i).innerHTML = 'Latest Adj. Closing Price: $'+ (newData[0][1].toFixed(2)) / NumberOfStocks;
      document.getElementById('totalPrice' + i).innerHTML = 'Total Value the shares of this Asset Contribute to Portfolio: $'+ newData[0][1].toFixed(2);
    newData.reverse();
