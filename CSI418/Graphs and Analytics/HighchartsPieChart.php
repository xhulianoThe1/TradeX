...
$_SESSION['graphCameFrom'] = 'HighchartsPieChart.php';
...
function createChart() {
  ...
  Highcharts.chart('container', {
    ...
    title: {
        text: 'Pie Chart for ' + "<?php echo $_SESSION['nameOfPortfolio'] ?>"
    },
    plotOptions: {
        pie: {
...
echo "<table style='border: solid 1px black;'>";
 echo "<h2><b>Stocks in Current Portfolio:<b><h2></tr>";
    ...
    function endChildren() {
        echo "</tr>" . "\n";
        echo '<td style="width: 150px; border: 3px solid black; font-weight: bold;"> <form action="../Delete/removeStock.php" method="post"><input style="background-color:red" type="submit" name= "'.$_SESSION['nameOfTicker'].'"value="Click to remove ' .$_SESSION['nameOfTicker'].' from Portfolio"></form>';
