...
echo "<table style='border: solid 1px black;'>";
 echo "<h2><b>Stocks in Current Portfolio:<b><h2></tr>";
    ...
    function endChildren() {
        echo "</tr>" . "\n";
        echo '<td style="width: 150px; border: 3px solid black; font-weight: bold;"> <form action="removeStock.php" method="post"><input style="background-color:red" type="submit" name= "'.$_SESSION['nameOfTicker'].'"value="Click to remove ' .$_SESSION['nameOfTicker'].' from Portfolio"></form>';
