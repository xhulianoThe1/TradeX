   ...
   <body>
      ...
      <div class="collapse" id="understanding">
         <div class="understandingBody">
             <!--Charts-->
            <b><u>Understanding the Charts</u></b>
            <p>As mentioned before, there are four different types of charts available for you to compare assets in your portfolio(s). A <b>Line Chart </b>is a graphical representation of an asset's historical price action that connects a series of data points with a continuous line. This is the most basic type of chart used in finance and typically only depicts a security's closing prices over time. Since stock prices tend to trend, trendlines that connect the highs or lows in the stock's price history can help identify the current trend and predict what the stock price might do in the future. The following depicts a line chart using Facebook (FB) and Google (GOOG).</p>
            ...
            <br> 
            <p>A stock <b>Bar Chart </b>is one of the other several ways that we have provide for your to visually analyze stock prices. A bar chart consists of a horizontal series of vertical lines, or bars, that each show a stock's range of prices for a certain time period. With a quick glance at a bar chart, you can see how a stock’s price has recently behaved and spot any potential price patterns. The following depicts a bar chart using Facebook (FB) and Google (GOOG)</p>
            <br> 
            <img title="Bar Chart" src ="User_Manual_Images/Bar.png" class="img-fluid"  height ="200" width ="700">  <br> 
            <br>
            <p>Finally, <b>High-Low Charts</b> show the high and low price a stock attained for a particular period of time. The chart displays a series of vertical lines where the top of the line shows the high price, the bottom of the line the low price. It is typically a technical indicator used by investors who view the 52-week high or low as an important factor in determining a stock's current value and predicting future price movement. The following depicts a high-low chart for Facebook (FB) and Google (GOOG)</p>
      ...
      <div class="collapse" id="inactivity">
         <div class="inactivityBody">
            ...
            <p> For your protection, we have enabled user inactivity warning messages that will automatically log you off after being inactive after a certain time period. These have been implemented both on the main page as well as on the user manual page. For example, on the main page, the user inactivity timer is set to notify after being inactive for 15 minutes whilst the user manual page will only allow for 10 minutes before you are kicked off the system for your protection. </p>
            <img title="Inactivity Warning" src ="User_Manual_Images/Inactivity.png" class="img-fluid" height ="150" width ="300">  <br>
            <br>
            <p>Once you are ready to signout of the application, you can easily do so by navigating to the top of your screen and tapping or clicking on <b>"Sign-out"</b> as shown in <i>Figure 10</i>. Doing so will save all your portfolios from being tampered with and this option is genrally the better way of going about being safe than simply just closing out of the browser. </p>
